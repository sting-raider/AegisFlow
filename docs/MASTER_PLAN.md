...
| A3 | Register baselines/challengers; run cost, ablation, held-family and cross-environment development experiments | In progress; DEV-SUP-001 failed objectives; three-way anomaly/open-set harness implemented, evidence run pending |
