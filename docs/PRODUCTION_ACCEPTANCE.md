...
|---|---|---|
| Frozen-evidence integrity | Exact report/config/source hashes; final-only policy; CI guard | v1/v2 archive guards pass on public runner commit `3659031`, CI `33661356302`; corrected FAMILY-002 report has separate bound evidence, publication guard CI pending |
...
| Challenger evidence | Registered baselines, costs, ablations, repeated held-family and cross-environment results | v1 negatives retained; corrected v2 FAMILY-002 completes six bound rotations and fails development gates; origin/ablation/cross-environment research remains incomplete |
