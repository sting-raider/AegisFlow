...
| Challenger evidence | Registered baselines, costs, ablations, repeated held-family and cross-environment results | Baselines, hybrid/temporal held-family, and aggregate root-cause evidence complete; one cross-fitted calibration experiment remains before candidate/NO-GO decision |
