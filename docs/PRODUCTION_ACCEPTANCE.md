...
| Challenger evidence | Registered baselines, costs, ablations, repeated held-family and cross-environment results | Supervised, anomaly, and hybrid/temporal held-family evidence complete; all fail objectives; root-cause and candidate/NO-GO decision open |
